...
--
-- Initial schema for the Business Messaging Sample Tech Provider App.
-- Applied automatically by Netlify DB on the first deploy.
-- Ported from the manual setup in README.md > Database Setup.
